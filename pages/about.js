...
export default function About() {
  ...
  const description = "About Syed Asif, Associate Network Engineer passionate about network automation, infrastructure as code, and modern DevOps practices.";
      ...
      <div className="bg-gray-50 min-h-screen text-gray-800">
        ...
        <main className="container mx-auto px-4 py-12 md:py-16">
          <div className="max-w-3xl mx-auto bg-white p-8 md:p-10 rounded-xl shadow-xl">
            <h1 className="text-3xl md:text-4xl font-bold text-gray-900 mb-6 text-center">About Me</h1>
            <div className="prose prose-lg max-w-none text-gray-700">
              ...
              <p>
                ...
                I aim to bridge the gap between networking and software development. My journey in tech is driven by a constant curiosity and a desire to build efficient, resilient systems.
              </p>
            </div>
          </div>
        </main>
